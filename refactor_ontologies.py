...
with open('scripts/fraghub_rust/src/ontologies_completion.rs', 'r') as f:
    content = f.read()
...
content = content.replace("pub fn ontologies_completion_processing<'py>(", "pub fn ontologies_completion_processing(")
...
old_loop = """    // --- Step 3: Boucle de mise à jour (In-place) ---
...
new_loop = """    // --- Step 3: Boucle de mise à jour (In-place) ---
...
with open('scripts/fraghub_rust/src/ontologies_completion.rs', 'w') as f:
    f.write(content)
